...
$tbl =
    '<table border="0" cellpadding="3" id="tabla_gral" style="display: none;">
        <tr>
            <td align="left" width="250" style="font-size: 12px; font-weight: bolder;">Resumen de Cuenta General '.((int)$sucursal == 0 ? ' - Todas las sucursales' : (($sucursalModel = Sucursal::findOne($sucursal)) ? ' - Sucursal: '.$sucursalModel->sucursal : 'Sucursal no encontrada')).'</td>
            <td align="left" width="130" style="font-size: 9px;  ">'.date("d/m/Y H:i:s").'</td>
        </tr>
        <tr>
            ...
            <td align="left" style="font-size: 11px;">';
                ...
                foreach ($personas as $g) {
                    ...
                    <tr style="font-size: 8px;">
                        ...
                        <th width="60" align="right">Compra</th>
                        <th width="60" align="right">Pago</th>
                    </tr>';
                    $debe = 0; $haber = 0;
                    foreach ($items as $m) {
...
<script>
    ...
    function exportarCtaGral() {
        ...
        var resultado = ExcellentExport.excel(linkTemporal, 'tabla_gral', 'Cuenta Corriente General');
