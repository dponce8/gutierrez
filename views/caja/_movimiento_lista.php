    <table class="table table-bordered" >
        ...
        <tr style="font-size: 8px;">
            ...
            <th width="90px" style="font-size: 8px; font-weight: bold">Empresa</th>
            ...
            <th width="60px" style="font-size: 8px; font-weight: bold">Usuario</th>
        ...
        <?php $c =1; foreach ($listado as $m) { $color='#000000'; if($m['estado'] == 0){$color='red';}?>
            <tr class="table-light" id="fila_m_<?=$c?>" style="font-size: 8px; cursor: pointer; color:<?=$color?>">
                ...
                <td width="90px" onClick="verMedios(<?=$m['idMov'].','.$c?>)"><?= $m['empresa']?></td>
                ...
                <td width="60px" onClick="verMedios(<?=$m['idMov'].','.$c?>)"><?= $m['usuario']?></td>
