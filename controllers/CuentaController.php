...
use app\models\BancoCuentaSearch;
...
class CuentaController extends Controller
{
    ...
    {
        $searchModel = new BancoCuentaSearch();
    ...
    /**
     * Creates a new BancoCuenta model.
    ...
    /**
     * Updates an existing BancoCuenta model.
    ...
    {
        if (($model = BancoCuenta::findOne(['id' => $id])) !== null) {
            return $model;
        }
